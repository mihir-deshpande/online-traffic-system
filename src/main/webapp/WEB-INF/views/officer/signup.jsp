...
<div class="container">
  ...
  <form:form action="#" modelAttribute="officer" method="post" cssClass="row g-3">
    <div class="col-md-6">
      ...
      <form:input path="officerName" id="officerName" cssClass="form-control" required="true" />
    </div>
    <div class="col-md-6">
      <label for="branch" class="form-label">Branch:</label>
      <form:input path="branch" id="branch" cssClass="form-control" required="true" />
    </div>
    <div class="col-md-6">
